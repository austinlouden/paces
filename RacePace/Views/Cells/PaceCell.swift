...
class PaceCell: UITableViewCell {
  ...
  override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    tagButton.titleEdgeInsets = UIEdgeInsets(
      top: 0, left: kSpacing + 2, bottom: 0, right: kSpacing + 2)
    ...
    NSLayoutConstraint.activate([
      ...
      paceLabel.leadingAnchor.constraint(
        equalTo: contentView.leadingAnchor, constant: kAppMargin + 4),
      raceLabel.leadingAnchor.constraint(equalTo: paceLabel.trailingAnchor, constant: 8),

      tagButton.trailingAnchor.constraint(
        equalTo: contentView.trailingAnchor, constant: -kAppMargin),
