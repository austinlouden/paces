  ...
  override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    NSLayoutConstraint.activate([
      ...
      distanceLabel.leadingAnchor.constraint(
        equalTo: contentView.leadingAnchor, constant: kAppMargin + kSpacing),
    ])
  }
  ...
  override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    NSLayoutConstraint.activate([
      ...
      unitLabel.trailingAnchor.constraint(
        equalTo: unitSwitch.leadingAnchor, constant: -kSpacing * 2),

      unitSwitch.centerYAnchor.constraint(equalTo: contentView.centerYAnchor),
      unitSwitch.trailingAnchor.constraint(
        equalTo: saveButton.leadingAnchor, constant: -kSpacing * 2),
